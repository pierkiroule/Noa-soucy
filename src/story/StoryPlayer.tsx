...
export function StoryPlayer() {
  ...
  return <main className="story">
    ...
    {mediaBlock && <StoryMediaPlayer key={mediaBlock.id} title={mediaBlock.title} text={mediaBlock.text} videoSrc={storyMediaUrl(mediaBlock.media.video)} variant={mediaBlock.type} breathIndex={state.currentBreathIndex} narrationEnded={Boolean(voiceSource && narrationEnded)} narrationSource={voiceSource} narrationDuration={mediaBlock.media.voiceDurationSeconds} onBreathChange={setBreath} onComplete={completeMedia}/>}
