...
export type PauseId = 'ocean-resonance' | 'resource-resonance' | 'navigation-resonance'
...
export interface StoryScene { type:'scene'; id:SceneId; title:string; duration:number; text:string; media:SceneMedia; effects:EffectCue[]; transitionIn:TransitionId; transitionOut:TransitionId; manualAdvance?:boolean }
export interface ProjectiveOption { id:string; label:string; params:Record<string,ParameterValue>; resonance?:{title:string;text:string} }
