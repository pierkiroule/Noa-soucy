...
export function NaoPassers({ nutId, onBack }: { nutId: string; onBack: () => void }) {
  ...
  return <NaoScreen className="passers-screen"><Brand/><button className="travel-back" onClick={onBack}>← Revenir à Nao</button><p className="eyebrow">NAO SOUCI</p><h1 className="nao-title">Livre d’Or•°</h1><p className="nao-subtitle">Ce que Nao a recueilli sur son passage.</p>
